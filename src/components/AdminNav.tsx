...
export default function AdminNav() {
  ...
  return (
    ...
    >
      <div className="flex items-center h-full px-4 max-w-6xl mx-auto gap-2">
        <a
          href="/admin/dashboard"
          className="font-bold text-sm leading-none shrink-0 text-white hover:text-gray-300 mr-4"
        >
          Admin
        </a>
